    ...
    <div className="CREATETEACH_WRAPPER">
      <section className="AATEA_mainPage">
        ...
        <form className="AATEA_addTeacher" method="POST">
          <label htmlFor="AATEA_teacherName" className="AATEA_text">
            Teacher Name
          </label>
          <input
            id="AATEA_teacherName"
            type="text"
            className="AATEA_box"
            value={teacherName}
            onChange={(e) => {
          ...
          />
          <label htmlFor="AATEA_teacherUsername" className="AATEA_text">
            Username
          </label>
          <input
            id="AATEA_teacherUsername"
            type="text"
            className="AATEA_box"
            value={username}
            onChange={(e) => {
          ...
          />
          <label htmlFor="AATEA_teacherPassword" className="AATEA_text">
            Password
          </label>
          <input
            id="AATEA_teacherPassword"
            type="password"
            className="AATEA_box"
            value={password}
            onChange={(e) => {
          ...
          />
          <label htmlFor="AATEA_teacherConfirmPassword" className="AATEA_text">
            Confirm Password
          </label>
          <input
            id="AATEA_teacherConfirmPassword"
            type="password"
            className="AATEA_box"
          ...
          />
          <button id="AATEA_submit" onClick={handleSubmit} type="submit">
            Add
          </button>
        </form>
        <div>
